...
print("Demo 09: Seleccion del Mejor Algoritmo de Regresion para el DataSet de Casas California")

print("Paso 1: Crear el DataSet")
dst = fetch_california_housing()
X = dst["data"]
y = dst["target"]
...
nombresModelos = ["LinearRegression", "RidgeCV", "SGDRegressor", "SVR", "DecisionTreeRegressor",
"AdaBoostRegressor", "BaggingRegressor", "ExtraTreesRegressor", "GradientBoostingRegressor",
"HistGradientBoostingRegressor", "RandomForestRegressor", 
"VotingRegressor"]
#, "StackingRegressor"

modelos = [LinearRegression(), RidgeCV(), SGDRegressor(), SVR(), DecisionTreeRegressor(),
AdaBoostRegressor(), BaggingRegressor(), ExtraTreesRegressor(), GradientBoostingRegressor(),
HistGradientBoostingRegressor(), RandomForestRegressor(), 
