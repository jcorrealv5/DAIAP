...
print("Primer Elemento: ", y_train[0])

print("3. Normalizar los datos de entrada")
scaler = StandardScaler()
X_train = scaler.fit_transform(X_train)
X_test = scaler.transform(X_test)
print("Shape despues de Normalizar X_train: ", X_train.shape)
...
joblib.dump(scaler, "Scaler_LFW_People.pkl")
joblib.dump(pca, "PCA_LFW_People.pkl")
