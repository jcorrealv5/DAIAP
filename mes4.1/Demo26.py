...
print("Demo 26: Entrenar y Guardar un Modelo Binario para Detectar Lentes")
horaInicio = datetime.now()

print("1. Crear el DataSet para Lentes con las Caras Guardadas")
rutaLentes = "C:/Data/Python/2026_01_DAIAP/DataSets/CelebA/Lentes/"
listaX = []
listaY = []
carpetas = os.listdir(rutaLentes)
for carpeta in carpetas:
    lentes = carpeta[0]
    print("_" * 100)
    print(f"Categoria: {carpeta}")
    print("_" * 100)
    archivos = os.listdir(rutaLentes + carpeta)
    for archivo in archivos:
        print(archivo)
        rutaArchivo = os.path.join(rutaLentes + carpeta, archivo)
...
joblib.dump(modelo, "Sklearn_Lentes.pkl")
