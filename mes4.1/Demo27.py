...
class Ventana(QDialog):
    def __init__(self):
        ...
        btnClasificar.clicked.connect(self.clasificarLentes)
        btnNuevo.clicked.connect(self.nuevo)
        self.modelo = joblib.load("Sklearn_Lentes.pkl")
    ...
    def abrirArchivo(self):
        dlg = QFileDialog()
        dlg.setDirectory(r"C:\Data\Python\2026_01_IAG\Demos\datasets\TestLentes")
    ...
    def clasificarLentes(self):
        ...
        if(nCaras>0):
            ...
            print(y_predecido)
            lentes = y_predecido[0]
            nombre = "Tiene Lentes" if lentes=="C" else "No Tiene Lentes"
