...
print("Demo 31: Entrenar y Guardar un Modelo Muticlase para Detectar Emociones con el Rostro con PCA y SVC")
...
print("4. Crear el Modelo con SVC")
modelo = SVC(kernel='rbf', class_weight='balanced')

print("5. Entrenar el Modelo")
modelo.fit(X_train, y_train)

print("6. Guardar el Modelo en Disco")
joblib.dump(modelo, "Sklearn_FER_SVC.pkl")
joblib.dump(pca, "Sklearn_FER_PCA_SVC.pkl")
...
print("7. Usar el Modelo para Clasificar la Emocion")
y_predict = modelo.predict(X_test)

print("8. Evaluar el Rendimiento del Modelo")
score = accuracy_score(y_test, y_predict)
print("Score: ", score)

print("9. Graficar la Matriz de Confusion")
