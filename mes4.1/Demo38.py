...
class Ventana(QDialog):
    def __init__(self):
        ...
        btnClasificar.clicked.connect(self.clasificarRaza)
        btnNuevo.clicked.connect(self.nuevo)
        self.modelo = joblib.load("Sklearn_Raza_Caras_MLP_500.pkl")
        self.pca = joblib.load("Sklearn_Raza_Caras_PCA_MLP_500.pkl")
    ...
    def abrirArchivo(self):
        dlg = QFileDialog()
        dlg.setDirectory(r"C:\Data\Python\2026_01_DAIAP\Imagenes\Razas\persona")
    ...
    def clasificarRaza(self):
        ...
        if(nCaras>0):
            ...
            cv2.rectangle(self.imagen, rec=(x,y,w,h), color=(255,0,0), thickness=4)
            ...
            self.lblPrediccion.setText(razas[indice])
            self.mostrarImagen()
