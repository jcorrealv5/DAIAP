...
class Ventana(QDialog):
    def __init__(self):
        ...
        btnClasificar.clicked.connect(self.clasificarRazas)
    ...
    def abrirArchivo(self):
        dlg = QFileDialog()
        dlg.setDirectory(r"C:\Data\Python\2026_01_DAIAP\Imagenes\Razas\grupo")
