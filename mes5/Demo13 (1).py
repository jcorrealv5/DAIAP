...
print("Demo 13: Entrenar y Guardar un Modelo CNN de Clasificacion de Digitos MNIST")
...
modelo = CNN_2C1P(hpTamanoLote, sizeImage, 10).to(device)
...
torch.save(modelo.state_dict(), "CNN_2C1P_MNIST.pt")
